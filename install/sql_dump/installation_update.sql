...
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) (SELECT NULL, abbreviation, '_HOTEL_EMAIL_ALERT', 'Used to reservation notifications' FROM `<DB_PREFIX>languages` FROM `<DB_PREFIX>languages`);
