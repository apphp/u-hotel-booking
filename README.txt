...
1. Installation:
   @site https://www.hotel-booking-script.com/index.php?page=installation
   or docs/Installation.html

2. Getting Started:
   @site https://www.hotel-booking-script.com/index.php?page=getting_started
   or docs/GettingStarted.html

-----------------------------------------------------------------------------------
For more information visit: 
	site 	@site https://www.hotel-booking-script.com/index.php?page=examples
