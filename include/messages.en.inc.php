...
define("_ACCOUNTS_SETTINGS","Accounts Settings");
...
define("_APPLY_PER","Apply Per");
define("_APPLY_PER_DESCRIPTION","Specifies whether to apply discount for room or for the whole hotel (for group discounts)");
...
define("_AVAILABILITY_ROOMS_NOTE","Define a maximum number of rooms available for booking for a specified day or date range (maximum availability _MAX_ rooms)<br>To edit room availability simply change the value in a day cell and then click 'Save Changes' button<br>To see additional room information put mouse pointer over the date");
...
define("_AWARD_POINTS","Award Points");
...
define("_CREATE_HOTEL_OWNER_ACCOUNT","Create Hotel Owner Account");
...
define("_CSS_CLASS_NAME","The CSS class name");
...
define("_DATE","Date");
define("_DATES_CHANGED_ALERT","Dates were changed. To be sure these changes make effect please click on &#034;Apply Changes&#034; link.");
...
define("_DISCOUNT_STD_CAMPAIGN_TEXT_EXT","available when ordering for _MIN_ _MAX_ adults");
...
define("_DOORS","Doors");
define("_DOUBLE_BEDS","Double Beds");
define("_DOWN","Down");
...
define("_FLAT_NOT_FOUND","Flat has not been found!");
...
define("_FLAT_WAS_ADDED","Flat has been successfully added to your reservation!");
define("_FLAT_WAS_REMOVED","Selected flat has been removed from your Reservation Cart!");
define("_FLAT_WITH_BEST_PRICE","Flat with the best price");
define("_FLOOR","Floor");
define("_FOLDING_SOFA_DOUBLE_BEDS","Folding Sofa Double Beds");
define("_FOLDING_SOFA_SINGLE_BEDS","Folding Sofa Single Beds");
...
define("_GROUND","Ground");
define("_GROUP","Group");
define("_GROUP_DISCOUNT","Group Discount");
...
define("_HOTEL_EMAIL_ALERT","Used to reservation notifications");
define("_HOTEL_EMPTY_ALERT","Field Select Hotel cannot be empty!");
define("_HOTEL_FACILITIES","Hotel Facilities");
define("_HOTEL_INFO","Hotel Info");
define("_HOTEL_MANAGEMENT","Hotel Management");
define("_HOTEL_NOT_EXISTS","The hotel with such name does not exist, or it is not active. Please try again.");
define("_HOTEL_OWNER","Hotel Owner");
define("_HOTEL_OWNERS","Hotel Owners");
define("_HOTEL_OWNERS_ACCOUNT_CREATED_CONF_LINK","Already confirmed your registration? Click <a href=index.php?admin=login&type=hotel_owners>here</a> to proceed.");
define("_HOTEL_OWNERS_CONFIRMED_ALREADY_MSG","Your account has already been confirmed! <br /><br />Click <a href='index.php?admin=login&type=hotel_owners'>here</a> to continue.");
define("_HOTEL_OWNERS_CONFIRMED_SUCCESS_MSG","You may now log into your account. Click <a href='index.php?admin=login&type=hotel_owners'>here</a> to proceed.");
define("_HOTEL_OWNERS_CONFIRMED_UPDATE_MSG","Thank you for confirming your registration! <br /><br />Please, to complete the registration, fill in the fields below on the page.");
define("_HOTEL_OWNER_LOGIN","Hotel Owner Login");
define("_HOTEL_PAYMENT_GATEWAYS","Hotel Payment Gateways");
define("_HOTEL_REGISTRATION_NUMBER","Hotel Registration Number");
...
define("_HOW_GOOGLE_MAPS_STEP_1","Follow this <a href=https://developers.google.com/maps/documentation/javascript/get-api-key#get-an-api-key target=_blank rel=&#034;noopener noreferrer&#034;>this link</a>  and click on Get a key.");
...
define("_ITEM_ALREADY_SELECTED","This item has been already selected!");
...
define("_LOCATION_AND_MAP","Location & Map");
...
define("_LOYALTY","Loyalty");
define("_LOYALTY_SETTINGS","Loyalty Settings");
define("_LUGGAGES","Luggages");
define("_MAILER","Mailer");
define("_MAIL_LOG","Mass Log");
define("_MAIN","Main");
...
define("_MAX_EMAIL_NEED_ASSISTANCE_ERROR","You have reached the maximum allowed number of emails per day");
...
define("_MAY","May");
define("_MD_ACCOUNTS","The Accounts module allows easy accounts management on your site. Administrator could create, edit or delete accounts.");
...
define("_MD_LOYALTY","This module allows site owners to manage and modify the points of customer loyalty. Customers can be rewarded by points after they complete their booking and redeem these points in future reservations.");
...
define("_MESSAGE_INFO_LINK_BOOKING","You can go to the order by clicking the <a href='index.php?page=booking'>&#034;booking&#034;</a> link in the footer menu");
...
define("_MINIMUM_BEDS_SHORT","Min. Number of Beds");
...
define("_MN_ALLOW_SOCIAL_LOGIN","Specifies whether to allow social login to customers");
...
define("_MSN_ALLOW_RELOCATION_TO_OTHER_HOTEL","Allow Relocation To Other Hotel");
define("_MSN_ALLOW_RELOCATION_TO_OTHER_ROOM","Allow Relocation To Other Room");
define("_MSN_ALLOW_RESERVATION_WITHOUT_ACCOUNT","Allow Reservation Without Account");
define("_MSN_ALLOW_SOCIAL_LOGIN","Allow Social Login");
...
define("_MSN_HOTEL_OWNER_ALLOW_REGISTRATION","Hotel Owner Allow Registration");
define("_MSN_HOTEL_OWNER_REGISTRATION_TYPE","Hotel owner registration type");
...
define("_MSN_MAX_EMAIL_NEED_ASSISTANCE","Max. emails for Need Assistance");
...
define("_MSN_POINTS_PER_RESERVATION","Loyalty Points per Reservation");
define("_MSN_POINT_RATE","Loyalty Point Rate");
...
define("_MSN_SEND_ORDER_COPY_TO_HOTEL_OWNER","Send Order Copy To Hotel Owner");
...
define("_MS_ALLOW_RELOCATION_TO_OTHER_HOTEL","Specifies whether allow relocation to other hotel on empty search results");
define("_MS_ALLOW_RELOCATION_TO_OTHER_ROOM","Specifies whether allow relocation to other room on empty search results");
...
define("_MS_HOTEL_OWNER_ALLOW_REGISTRATION","Specifies whether to allow hotel owner to register");
define("_MS_HOTEL_OWNER_REGISTRATION_TYPE","Specifies the registration method for the hotel owner, Advanced/Standard.");
define("_MS_HOTEL_RELOCATION","Hotel Relocation");
...
define("_MS_MAX_EMAIL_NEED_ASSISTANCE","Specifies the maximum allowed number of emails from customer to hotel per day");
...
define("_MS_POINTS_PER_RESERVATION","Specifies amount of loyalty points that customer gets for each reservation");
define("_MS_POINT_RATE","Specifies rate of each loyalty point in default currency");
...
define("_MS_RELOCATION_GET_DISCOUNT","Pay for one and stay in two and get 10% off rate.");
define("_MS_RELOCATION_HOTEL_PROGRAM","Enjoy 10% off rate when you choose smart relocation program<br>Now get oriented by splitting your holiday in two hotels, same area, same hotel category.<br>And free transfer, accept now and experience the difference.");
define("_MS_RELOCATION_ROOM_PROGRAM","Enjoy 10% off when u choose smart relocation program.<br>You can have full stay at same hotel but at different rooms category - just check in & hotel will handle the rest - accept now and get 10%.");
define("_MS_RELOCATION_TO_OTHER_HOTEL","This Relocation Hotel");
define("_MS_RELOCATION_TO_OTHER_ROOM","This Relocation Room");
...
define("_MS_ROOM_RELOCATION","Room Relocation");
...
define("_MS_SEND_ORDER_COPY_TO_HOTEL_OWNER","Specifies whether to allow sending a copy of order to hotel owner");
...
define("_MY_CUSTOMERS","My Customers");
...
define("_NAME_EMPTY_ALERT","Name cannot be empty! Please re-enter.");
...
define("_NOT_DEFINED","Not Defined");
...
define("_ORDER_PLACED_MSG","Thank you! The order has been placed in our system and will be processed shortly. <br>Your booking number is: _BOOKING_NUMBER_.");
...
define("_PAYMENT_GATEWAYS","Payment Gateways");
...
define("_PERFORM_ADDITIONAL_SEARCH","Perform additional search, please wait...");
...
define("_RESERVATIONS_AND_PAYMENTS","Reservations and Payments");
...
define("_ROOMS_COUNT","Number of Rooms (in the property)");
...
define("_SELECTED_FLATS","Selected Flats");
...
define("_SINGLE_BEDS","Single Beds");
...
define("_SOMEONE_FROM_SITE_CONTACTED_YOU","Someone from {SITE} contacted you");
...
define("_STATUS_DESCRIPTION","Status Description");
define("_STATUS_NOT_CHANGED","Status not changed");
define("_STEAM","Steam");
define("_STOP","Stop");
define("_ST_FLOOR","st Floor");
define("_SU","Su");
...
define("_SUITABLE_FOR_KIDS","Suitable For Kids");
define("_SUMMARY","Summary");
define("_SUN","Sun");
define("_SUNDAY","Sunday");
define("_SWIPE_ICON_ALERT","Swipe to view more...");
define("_SWITCH_TO_EXPORT","Switch to Export");
define("_SWITCH_TO_NORMAL","Switch to Normal");
define("_SWITCH_YEARS","Switch Years");
define("_SWITCH_YEARS_CONFIRM","Are you sure you want to switch the years to availability of this rooms?");
define("_SWITCH_YEARS_SAVED","Switch years successfully saved! Please refresh the Home Page to see the results.");
...
define("_TOTAL_NUMBER_OF_BEDS","Total Number Of Beds");
...
define("_TO_SET_UNLIMITED_TOOLTIP","To set &#034;unlimited&#034; enter &#034;_VAL_&#034;");
...
define("_TYPE_HOTEL_OR_LOCATION","Type here hotel name, landmark or location");
...
define("_UP","Up");
define("_UPDATE_CURRENCY_RATE","Update Currency Rates");
...
define("_VIDEO","Video");
define("_VIDEO_LINK","Video Link");
define("_VIDEO_LINK_TOOLTIP","Copy the video link and paste it into the field.");
